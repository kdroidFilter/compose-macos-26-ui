...
// inside MacosTheme, and provided via LocalComponentStyling.
//
// Access through MacosTheme.componentStyling.
// ===========================================================================

/**
 * Holds the default [*Style] instance for every macOS UI component.
 *
 ...
 *
 * Called inside [MacosTheme] so that component styles always reflect the
...
val LocalComponentStyling = staticCompositionLocalOf {
