...
@Composable
expect fun MacosFontFamily(): FontFamily

/**
 * macOS UI typography scale — macOS Human Interface Guidelines naming.
 *
...
data class Typography(
    ...
    internal fun withFontFamily(fontFamily: FontFamily): Typography = copy(
