...
mavenPublishing {
    coordinates(
        ...
        artifactId = "compose-macos-ui-icons-extended",
        version = version,
    )

    pom {
        name.set("Compose Macos UI Icons Extended")
        description.set(
...
android {
    namespace = "io.github.kdroidfilter.nucleus.ui.apple.macos.icons.extended"
