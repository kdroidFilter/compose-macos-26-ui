...
SRC="$SCRIPT_DIR/SFSymbolBridge.m"
...
echo "Building arm64..."
clang -arch arm64 "${COMMON_FLAGS[@]}" -o "$OUT_DIR_ARM64/libmacosui_icons_jni.dylib" "$SRC"
strip -x "$OUT_DIR_ARM64/libmacosui_icons_jni.dylib"

echo "Building x86_64..."
clang -arch x86_64 "${COMMON_FLAGS[@]}" -o "$OUT_DIR_X64/libmacosui_icons_jni.dylib" "$SRC"
strip -x "$OUT_DIR_X64/libmacosui_icons_jni.dylib"
