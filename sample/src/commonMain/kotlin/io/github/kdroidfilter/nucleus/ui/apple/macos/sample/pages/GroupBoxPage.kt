            ...
            Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                Row(
                    ...
                    Row(
                        ...
                        Icon(if (darkMode) LucideMoon else LucideSun, modifier = Modifier.size(16.dp), tint = MacosTheme.colorScheme.textSecondary)
                        Text("Dark Mode", style = MacosTheme.typography.subheadline)
                    }
                ...
                Row(
                    ...
                    Text("Follow system", style = MacosTheme.typography.subheadline)
        ...
        GroupBox(label = "Text Size") {
            ...
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                Row(
                    ...
                    Text("Size", style = MacosTheme.typography.caption1, color = MacosTheme.colorScheme.textTertiary)
                    Text("${size.toInt()}pt", style = MacosTheme.typography.caption1, color = MacosTheme.colorScheme.textTertiary)
                }
    ...
    GroupBox(label = "Notifications") {
        Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
            Row(
                ...
                Text("Allow notifications", style = MacosTheme.typography.subheadline)
            ...
            Row(
                ...
                Text("Sounds", style = MacosTheme.typography.subheadline)
            ...
            Row(
                ...
                Text("Badges", style = MacosTheme.typography.subheadline)
        ...
        Column(
            ...
            options.forEach { option ->
                Row(
                    ...
                    Text(option, style = MacosTheme.typography.subheadline)
                }
            }
        }
    }
            ...
            Column(
                ...
                themes.forEach { t ->
                    Row(
                        ...
                        Text(t, style = MacosTheme.typography.subheadline)
                    }
                }
            }
        }
        ...
        GroupBox(label = "Editor") {
            Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                Row(
                    ...
                    Text("Auto Save", style = MacosTheme.typography.subheadline)
                ...
                Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                    Row(
                        ...
                        Text("Font Size", style = MacosTheme.typography.subheadline)
                        Text("${fontSize.toInt()}px", style = MacosTheme.typography.caption1, color = MacosTheme.colorScheme.textTertiary)
                    }
